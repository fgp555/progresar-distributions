...
async function seedProgresar() {
    try {
        ...
        const staticUserIds = [
            ...
            // "3417bd97-8ae9-49b2-91f0-4575a8e94e4f", // BRAYAN MORENO - REMOVIDO
        ...
        const staticAccountIds = [
            ...
            // "99a707f1-7896-46c0-8ec5-fc42605057ec", // Cuenta 1005 - BRAYAN M. - REMOVIDO
        ...
        const cuentasData = [
            ...
            // { userId: staticUserIds[4], accountId: staticAccountIds[4], numeroCuenta: "1005" }, // BRAYAN MORENO - REMOVIDO
