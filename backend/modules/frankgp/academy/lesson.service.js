...
class LessonService {
    constructor() {
        this.repo = typeOrmConfig_1.AppDataSource.getRepository(lesson_entity_1.LessonEntity);
        this.sectionRepo = typeOrmConfig_1.AppDataSource.getRepository(section_entity_1.SectionEntity);
    }
    async create(data) {
