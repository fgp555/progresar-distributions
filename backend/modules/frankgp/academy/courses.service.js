...
class CoursesService {
    constructor() {
        this.courseRepo = typeOrmConfig_1.AppDataSource.getRepository(course_entity_1.CourseEntity);
        this.categoryRepo = typeOrmConfig_1.AppDataSource.getRepository(category_entity_1.CategoryEntity);
        this.lessonRepo = typeOrmConfig_1.AppDataSource.getRepository(lesson_entity_1.LessonEntity);
    }
    async create(data) {
        let category = null;
